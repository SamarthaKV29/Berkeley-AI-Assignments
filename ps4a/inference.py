...
class ExactInference(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        if noisyDistance == None:
            ...
            cnt = 0
            while(cnt < poslen):
                distance = util.manhattanDistance(self.legalPositions[cnt], pacmanPosition)
                allPossible[self.legalPositions[cnt]] = emissionModel[distance] * self.beliefs[self.legalPositions[cnt]]
                cnt += 1
...
class ParticleFilter(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        pacmanPosition = gameState.getPacmanPosition()
        "*** YOUR CODE HERE ***"
        for noisyDistance in emissionModel:
            print pacmanPosition, noisyDistance
